...
export const ContactSection = () => (
  <section className="flex flex-col gap-6" id="contact">
    <div className="grid grid-cols-1 items-center gap-5 rounded-[6px] border border-[rgba(116,99,150,0.12)] bg-[#f9f9f9] p-6 sm:grid-cols-[210px,1fr]">
      ...
      <div className="flex flex-col gap-2">
        <h3 className="text-[38px]">Let&apos;s connect!</h3>
